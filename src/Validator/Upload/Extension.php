...
namespace Sirius\Validation\Validator\Upload;
...
class Extension extends AbstractValidator {
    ...
    function validate($value, $valueIdentifier = null)
    {
        ...
        if (!is_array($value) || !isset($value['tmp_name']) || !file_exists($value['tmp_name'])) {
	    	...
	    	$this->success = is_array($this->options[self::OPTION_ALLOWED_EXTENSIONS]) && in_array($extension, $this->options[self::OPTION_ALLOWED_EXTENSIONS]);
	    }
        return $this->success;
    }
